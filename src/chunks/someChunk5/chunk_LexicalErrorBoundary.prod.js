__d(
  ...
  function $module_LexicalErrorBoundary_prod(
    ...
    'use strict';
    var c_react;
    var h = c_react || (c_react = require('react'));
    function m(b, c) {
      ...
      u = (function (b) {
        function c() {
          ...
          a.resetErrorBoundary = function () {
            ...
            null == a.props.onReset
              ? void 0
              : (k = a.props).onReset.apply(k, q);
            a.reset();
          };
          return a;
        }
        ...
        g.componentDidUpdate = function (a, d) {
          ...
          if (
            ...
            var e, k;
            null == (e = (k = this.props).onResetKeysChange)
              ? void 0
              : e.call(k, a.resetKeys, f);
            this.reset();
          }
        };
        g.render = function () {
          var a = this.state.error,
            d = this.props,
            f = d.fallbackRender,
            e = d.FallbackComponent;
          d = d.fallback;
          if (null !== a) {
            a = { error: a, resetErrorBoundary: this.resetErrorBoundary };
            if (h.isValidElement(d)) return d;
            if ('function' === typeof f) return f(a);
            if (e) return h.createElement(e, a);
            throw Error(
