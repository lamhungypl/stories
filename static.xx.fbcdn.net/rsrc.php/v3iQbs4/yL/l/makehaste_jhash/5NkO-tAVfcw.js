...
__d(
  ...
  ['CometTriggerAccessibilityAlertContext', 'react', 'recoverableViolation'],
  function (a, b, c, d, e, f, g) {
    ...
    var h = b.useCallback,
      i = b.useContext;
    function a() {
      var a = i(c('CometTriggerAccessibilityAlertContext'));
      return h(
        function (b) {
          if (a == null) {
            c('recoverableViolation')(
              'triggerAccessibilityAlert callback was null in useAccessibilityAlert',
              'comet_ax',
            );
            return;
          }
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, e) {
      ...
      var g = f.h,
        ...
        m = f.preloading_spi,
        n = f.spi,
        o = f.sprite_css_class,
        p = f.sprite_map_css_class,
        q = f.sprited,
        r = f.sz,
        s = f.uri,
        t = f.w;
      ...
      var u = null;
      if (q === 0)
        u = { height: j, loggingID: k, sprited: q, uri: s, width: f };
      else if (q === 1)
        u = {
          _spi: m,
          loggingID: k,
        ...
        u = { h: g, loggingID: k, p: l, spi: n, sprited: q, sz: r, w: t };
      else
...
__d(
  'CometEmoji.react',
  ['CometImage.react', 'FBEmojiResource', 'react'],
  function (a, b, c, d, e, f, g) {
    'use strict';
    var h = d('react');
    function a(a) {
    ...
    function a(a) {
      ...
      l =
        (b == null ? void 0 : b.type) === 'availabilityBadge'
          ...
          ? h.jsx('div', {
              className:
                'x10l6tqk' +
                (n ? ' x1ey2m1c x78zum5 xds687c x13a6bvl x17qophe' : ''),
              style: n ? void 0 : m,
      ...
      return h.jsxs('div', {
        ...
        children: [
          ...
          h.jsx('div', {
            className:
              'x1ey2m1c x10l6tqk x17qophe' +
              (o === !0
                ? ' xu3qyrb x5azwcr xssttbw xt910rc x14yjl9h xudhj91 x18nykt9 xww2gxu'
                : ''),
            children: h.jsx(
              c('TetraProfilePhoto.react'),
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a, b) {
      ...
      D = h.jsxs('div', {
        className:
          'x6s0dn4 x1q0q8m5 x1qhh985 xu3j5b3 xcfux6l x26u7qi xm0m39n x13fuv20 x972fbf x9f619 x78zum5 x1q0g3np x1iyjqo2 xs83m0k x1qughib xat24cr x11i5rnm x1mh8g0r xdj266r xeuugli x18d9i69 x1sxyh0 xurb0ha xexx8yu x1n2onr6 x1ja2u2z' +
          (T !== 'small'
            ? ' x1gg8mnh'
            : '' + (Y && T !== 'small' ? ' x1wiwyrm' : ' x2lwn1j')),
        ...
        children: [
          ...
          h.jsxs('div', {
            ...
            children: [
              h.jsxs('div', {
                className:
                  'x1q0q8m5 x1qhh985 xu3j5b3 xcfux6l x26u7qi xm0m39n x13fuv20 x972fbf x9f619 x78zum5 x1r8uery x1iyjqo2 xs83m0k x1qughib x11i5rnm x1mh8g0r x2lwn1j xeuugli x4uap5 xkhd6sd x1n2onr6 x1ja2u2z' +
                  (($
                    ? ' x6s0dn4 x1q0g3np x4cne27 xifccgj x1a02dak'
                    : ' x1qjc9v5 xdt5ytf xat24cr xdj266r' +
                      (P && W ? '' : '' + (P ? '' : '' + (W ? '' : '')))) +
                    (P && W
                      ? ' xz9dl7a xsag5q8'
                      : '' +
                        (P
                          ? ' xyamay9 x1l90r2v'
                          : '' +
                            (W ? ' x1y1aw1k xwib8y2' : ' xz9dl7a xsag5q8')))),
                children: [
                  h.jsx('div', {
                    className:
                      '' +
                      ($
                        ? ' x9f619 x4pfjvb x1iyjqo2 xs83m0k x193iq5w x1mkiy5m x10b6aqq x1pi30zi x1yrsyyn'
                        : ''),
                  ...
                  d != null &&
                    h.jsx('div', {
                      className:
                        'x78zum5' +
                        ((d.type === 'override-row'
                          ? ' x1q0g3np x11i5rnm x1mh8g0r'
                          : ' xdt5ytf x12rz0ws' +
                            (d.type === 'facepile'
                              ? ' x169t7cy'
                              : ' x16hk5td')) +
                          ($
                            ? ' x1yrsyyn x1iyjqo2 x10b6aqq'
                            : '' +
                              (d.type === 'override-row'
                                ? ' x1yrsyyn'
                                : '' + (d.type === 'facepile' ? '' : '')))),
    ...
    var n = function (a) {
      ...
      o = function (a) {
        ...
        return h.jsxs('div', {
          className:
            'x6s0dn4 x78zum5 x1q0g3np' +
            (b.type === 'switch' ? ' x47corl' : ''),
          children: [
            g != null &&
              h.jsx('div', {
                className: 'x2lah0s',
...
__d(
  'TetraListCell.react',
  ['CometListCellStrict.react', 'react'],
  function (a, b, c, d, e, f, g) {
    'use strict';
    var h = d('react');
    function a(a, b) {
...
__d(
  ...
  function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
      return h.jsx(
        c('BaseHeading.react'),
        babelHelpers['extends']({ xstyle: i.visuallyHidden }, a),
      );
    }
    a.displayName = a.name + ' [from ' + f.id + ']';
    g['default'] = a;
