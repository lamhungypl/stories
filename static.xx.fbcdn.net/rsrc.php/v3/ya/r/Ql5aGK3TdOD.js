...
(function (a) {
  ...
  function _require_(a) {
    a = C(a);
    if (a) return D(a);
  }
  function _importDefault_(a) {
    a = C(a);
    if (a) return a.defaultExport !== q ? a.defaultExport : null;
  }
  function _importNamespace_(a) {
    a = C(a);
  ...
  function H(d) {
    ...
    if (s.call(k) === '[object Function]' && l != null) {
      ...
      try {
        ...
        for (h = 0; h < n; h++) {
          y = l[h];
          v.length < w && v.push(_require_.call(null, y.id));
        }
        var A;
        x && (A = z());
        f[g.id].factoryRun = !0;
  ...
  function _define_(name, deps, e, g, h, i, l, m) {
    deps === void 0
      ? ((deps = []), (e = name), (name = oa()))
      : e === void 0 &&
        ((e = deps),
        s.call(name) === '[object Array]'
          ? ((deps = name), (name = oa(deps.join(','))))
          : (deps = []));
    var n = { cancel: na.bind(this, name) },
      o = la(name);
    if (!deps && !e && i) {
      o.refcount += i;
      return n;
    ...
    N &&
      (name in O && delete O[name], Array.isArray(deps) && ka(name, deps, m));
    f[name] = {
      id: name,
      dependencies: deps,
      meta: l,
    ...
    if (d.length > 0) {
      ...
      l(function () {
        if (w) {
          for (var a = 0; a < p.length; a++) _require_.call(null, p[a].id);
          p.length = 0;
        } else while (p.length > 0) _require_.call(null, p.pop().id);
      })();
    }
    return n;
  }
  ...
  V('global', a);
  V('require', _require_);
  V('importDefault', _importDefault_);
  V('importNamespace', _importNamespace_);
  V('requireDynamic', _requireDynamic_);
  V('requireLazy', _requireLazy_);
  V('requireWeak', W);
  V('ifRequired', X);
  V('ifRequireable', Y);
  b = [
    _require_.call(null, 'global'),
    _require_.call(null, 'require'),
    _require_.call(null, 'requireDynamic'),
    _require_.call(null, 'requireLazy'),
    null,
    null,
  ];
  c = [
    _require_.call(null, 'global'),
    _require_.call(null, 'require'),
    _require_.call(null, 'importDefault'),
    _require_.call(null, 'importNamespace'),
    _require_.call(null, 'requireLazy'),
    null,
    null,
  ];
  ...
  a.define = _define_;
  a.require = _require_;
  a.importDefault = _importDefault_;
  a.importNamespace = _importNamespace_;
  a.requireDynamic = _requireDynamic_;
  a.requireLazy = _requireLazy_;
  a.__onBeforeModuleFactory = null;
  a.__onAfterModuleFactory = null;
  function _requireDynamic_(a, b) {
  ...
  function Y(a, b, c) {
    ...
    if (d && d.nonJSDeps && T(d)) {
      if (typeof b === 'function') return b(_require_.call(null, a));
    } else if (typeof c === 'function') return c();
  }
  $ = {
  ...
  V('__debug', $);
  a.__d = function (name, deps, someFn, someNumber, e) {
    Z()(
      function () {
        _define_(
          name,
  ...
  if (a.__rl_stub) {
    for (W = 0; W < a.__rl_stub.length; W++)
      _requireLazy_.apply(null, a.__rl_stub[W]);
    delete a.__rl_stub;
  }
  Y = function () {};
  a.$RefreshReg$ = Y;
...
__d(
  ...
  function (a, b, c, d, e, f) {
    'use strict';
    var g;
    window.MutationObserver && (g = b('unstable_server-external-runtime'));
    e.exports = g;
  },
  3,
);
