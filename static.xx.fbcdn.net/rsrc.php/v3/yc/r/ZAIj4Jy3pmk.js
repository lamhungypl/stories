              ...
              return g
                ? b.db
                    ...
                    .add({
                      ...
                      lastMessageCtaTimestampMs: a[64],
                      threadDescription: a[67],
                      unsendLimitMs: a[68],
                      capabilities2: a[76],
                      capabilities3: a[77],
                      syncGroup: a[80],
                      threadInvitesEnabled: a[81],
                      threadInviteLink: a[82],
                      isAllUnreadMessageMissedCallXma: a[83],
                      lastNonMissedCallXmaMessageTimestampMs: a[84],
                      threadInvitesEnabledV2: a[86],
                      hasPendingInvitation: a[89],
                      eventStartTimestampMs: a[90],
                      eventEndTimestampMs: a[91],
                      takedownState: a[92],
                      igFolder: a[93],
                      inviterId: a[94],
                      threadTags: a[95],
      ...
      return c.seq([
        function (d) {
          return c.seq([
            function (b) {
              return c
                .ftr(c.db.table(162).fetch([[[a[0]]]]), function (b) {
                  return (
                    c.i64.eq(b.folderId, a[0]) && c.i64.gt([0, 80], [0, 80])
                  );
                })
                .next()
                .then(function (b) {
                  ...
                  return d
                    ? c.db
                        ...
                        .put({
                          ...
                          description: a[3],
                          pictureUrl: a[5],
                          pictureUrlFallback: a[6],
                          pictureUrlExpirationTimestampMs: a[7],
                          capabilities: a[11],
                          capabilities2: a[12],
                          capabilities3: a[13],
                          notificationSetting: a[14],
                          notificationMutedUntil: a[15],
                          sendsBlockedUntil: a[16],
                          isHidden: a[17],
                          hasSeenDisablingAlert: a[18],
                          inviteLink: a[19],
                          directInviteLink: a[20],
                          enableState: a[21],
                          fbGroupType: a[22],
                          threadCount: a[24],
                          disableTimestamp: a[23],
                          inviteStatus: a[26],
                          categoryCount: a[25],
                          snippetText: a[27],
                          coverPicUrl: a[28],
                          coverPicUrlFallback: a[29],
                          coverPicUrlExpirationTimestampMs: a[30],
                          invitedThreadId: a[31],
                        })
                    : 0;
                });
            },
...
__d(
  ...
  function (a, b, c, d, e, f) {
    function a() {
      ...
      return b.seq([
        function (c) {
          return b.db.table(166).put({ communityId: a[0] });
        },
        function (a) {
          return b.resolve(c);
        },
